...
![Send](/images/33/5.png)

#### TCP的接收

![Recv](/images/33/6.png)

#### 协议栈完整的收发流程

![协议栈发送接收流程](/images/33/7.png)
...
![多线程](/images/33/13.png)

也不必多说了吧？对其进行简单的优化就是**线程池模型**了。

![线程池](/images/33/14.png)
...
[简单的epoll使用](https://github.com/hurley25/Experiment/blob/master/epoll/epoll.c)
